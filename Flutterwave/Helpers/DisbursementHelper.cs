...
namespace Flutterwave.Helpers
{
    public class DisbursementHelper
    {
        ...
        {
            resources.Add("staging", new DisbursementOperation
            {
            ...
            resources.Add("production", new DisbursementOperation
            {
        ...
        public async Task<string> Link(string accountno, Driver driver)
        {
            ...
            var response = await new ApiRequest(resource).MakeRequest(data: linkDisbursement, method: Verbs.POST);
            return response;
        }
        public async Task<string> Validate(string otp, string reference, Driver driver, string otptype = Verification.SMS)
        {
            ...
            var response = await new ApiRequest(resource).MakeRequest(data: disbursement, method: Verbs.POST);
            return response;
        }
        public async Task<string> GetLinkedAccounts(Driver driver)
        {
            ...
            var response = await new ApiRequest(resource).MakeRequest(data: linkedAccountData, method: Verbs.POST);
            return response;
        }
